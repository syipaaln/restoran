                    ...
                    <div class="container-fluid px-4">
                        <div class="row mt-5 mb-5">
                            <div class="col-lg-12 d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <a class="btn btn-success" href="{{ route('detailpesanan.create') }}">Tambah Detail Pesanan</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <table class="table table-bordered">
                            <tr>
                                ...
                                {{-- <th width="100px" class="text-center">Id Detail</th> --}}
                                <th width="120px" class="text-center">Id Pesanan</th>
                                <th width="180px" class="text-center">Nama Menu</th>
                                <th width="20px" class="text-center">Harga</th>
                                <th width="20px" class="text-center">Jumlah</th>
                                <th width="200px"class="text-center">Subtotal Harga</th>
                                <th width="280px"class="text-center">Action</th>
                            </tr>
                            @foreach ($detailpesanan as $detailpesanan => $item)
                            <tr>
                                <td class="text-center">{{ ++$detailpesanan }}</td>
                                ...
                                <td class="text-center">
                                    <form action="{{ route('detailpesanan.destroy',$item->id_detail) }}" method="POST">
                    
                                        <a class="btn btn-info btn-sm" href="{{ route('detailpesanan.show',$item->id_detail) }}">Show</a>
                    
                                        <a class="btn btn-primary btn-sm" href="{{ route('detailpesanan.edit',$item->id_detail) }}">Edit</a>
