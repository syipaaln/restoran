...
<form action="{{ route('detailpesanan.store') }}" method="POST">
    @csrf
     ...
     <div class="row">
        {{-- <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="id_detail" class="form-control" placeholder="Id Detail Pesanan">
            </div>
        </div> --}}
        {{-- <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="pelanggan-option" name="id_pesanan">
                    @foreach ($pesanan as $pesan)
                        <option value="{{ $pesan->id_pesanan }}">{{ $pesan->id_pesanan }}</option>
                    @endforeach
                 </select>
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="number" name="jumlah" id="jumlah" class="form-control" placeholder="Jumlah Pesanan">
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Subtotal Harga:</strong>
                <input type="number" name="subtotal" id="subtotal" class="form-control" placeholder="Subtotal Harga" readonly>
            </div>
        </div>
