                    ...
                    <div class="container-fluid px-4">
                        <div class="row mt-5 mb-5">
                            <div class="col-lg-12 d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <a class="btn btn-success" href="{{ route('kategori.create') }}">Tambah kategori Menu</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <table class="table table-bordered">
                            <tr>
                                ...
                                <th width="20px" class="text-center">Id Kategori</th>
                                <th width="280px"class="text-center">Nama Kategori</th>
                                <th width="280px"class="text-center">Action</th>
                            </tr>
                            @foreach ($kategori as $kategori => $item)
                            <tr>
                                ...
                                <td class="text-center">
                                    <form action="{{ route('kategori.destroy',$item->id_kategori) }}" method="POST">
                                       ...
                                       <a class="btn btn-info btn-sm" href="{{ route('kategori.show',$item->id_kategori) }}">Show</a>
                    
                                        <a class="btn btn-primary btn-sm" href="{{ route('kategori.edit',$item->id_kategori) }}">Edit</a>
                    
                                        @csrf
                                        @method('DELETE')
                    
                                        <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Jika Anda menghapus data ini, Anda akan menghapus data menu yang menggunakan kategori ini. Apakah Anda yakin ingin menghapus data ini?')">Delete</button>
                                    </form>
                                </td>
                            </tr>
                            @endforeach
